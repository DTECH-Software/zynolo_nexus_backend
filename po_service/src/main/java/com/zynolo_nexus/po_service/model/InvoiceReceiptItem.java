...
@Setter
@Entity
@Table(name = "invoice_receipt_items")
public class InvoiceReceiptItem {
    ...
    @JoinColumn(name = "invoice_receipt_id", nullable = false)
    ...
    @Column(name = "approved_quantity", nullable = false, precision = 18, scale = 2)
    private BigDecimal approvedQuantity;

    @Column(name = "received_quantity", nullable = false, precision = 18, scale = 2)
    private BigDecimal receivedQuantity;

    @Column(name = "invoiced_quantity", nullable = false, precision = 18, scale = 2)
