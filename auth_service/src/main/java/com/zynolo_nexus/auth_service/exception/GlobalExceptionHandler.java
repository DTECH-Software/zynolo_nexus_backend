...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<MessageResponseDTO<Object>> handleUnauthorized(UnauthorizedException ex) {
    ...
    public ResponseEntity<MessageResponseDTO<Object>> handleIllegalArgument(IllegalArgumentException ex) {
        MessageResponseDTO<Object> body = MessageResponseDTO.builder()
                .success(false)
