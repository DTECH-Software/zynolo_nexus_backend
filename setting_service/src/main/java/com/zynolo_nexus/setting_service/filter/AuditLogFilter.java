...
public class AuditLogFilter extends OncePerRequestFilter {
    ...
    private static final Map<String, String> POST_EVENTS = Map.ofEntries(
            ...
            Map.entry("/api/v1/setting/user-companies", "USER_COMPANY_CREATE"),
            Map.entry("/api/v1/setting/user-companies/view", "USER_COMPANY_VIEW"),
            Map.entry("/api/v1/setting/user-companies/update", "USER_COMPANY_UPDATE"),
            Map.entry("/api/v1/setting/user-companies/status", "USER_COMPANY_STATUS_UPDATE"),
            Map.entry("/api/v1/setting/user-companies/filter-list", "USER_COMPANY_FILTER_LIST"),
            Map.entry("/api/v1/setting/user-companies/reference-data", "USER_COMPANY_REFERENCE_DATA"),
            Map.entry("/api/v1/setting/company-modules", "COMPANY_MODULE_SUBSCRIPTION_CREATE"),
            Map.entry("/api/v1/setting/company-modules/view", "COMPANY_MODULE_SUBSCRIPTION_VIEW"),
            Map.entry("/api/v1/setting/company-modules/update", "COMPANY_MODULE_SUBSCRIPTION_UPDATE"),
            Map.entry("/api/v1/setting/company-modules/status", "COMPANY_MODULE_SUBSCRIPTION_STATUS"),
            ...
            Map.entry("/api/v1/setting/banks", "BANK_CREATE"),
            Map.entry("/api/v1/setting/banks/update", "BANK_UPDATE"),
            Map.entry("/api/v1/setting/banks/view", "BANK_VIEW"),
            Map.entry("/api/v1/setting/banks/status", "BANK_STATUS_UPDATE"),
            Map.entry("/api/v1/setting/banks/filter-list", "BANK_FILTER_LIST"),
            Map.entry("/api/v1/setting/banks/reference-data", "BANK_REFERENCE_DATA"),
            ...
            Map.entry("/api/v1/setting/role-page-tasks/preview", "ROLE_PAGE_TASK_ACCESS_PREVIEW")
    );
